...
import { Route as AuthenticatedUserRankingRouteImport } from './routes/_authenticated/user-ranking'
...
const AuthenticatedUserRankingRoute =
  AuthenticatedUserRankingRouteImport.update({
    id: '/user-ranking',
    path: '/user-ranking',
...
export interface FileRoutesByFullPath {
  ...
  '/user-ranking': typeof AuthenticatedUserRankingRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/user-ranking': typeof AuthenticatedUserRankingRoute
  '/console/log': typeof ConsoleLogRoute
  '/console/topup': typeof ConsoleTopupRoute
  '/oauth/$provider': typeof OauthProviderRoute
  '/about/': typeof AboutIndexRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/user-ranking': {
      id: '/_authenticated/user-ranking'
      path: '/user-ranking'
      fullPath: '/user-ranking'
      preLoaderRoute: typeof AuthenticatedUserRankingRouteImport
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedUserRankingRoute: typeof AuthenticatedUserRankingRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedUserRankingRoute: AuthenticatedUserRankingRoute,
